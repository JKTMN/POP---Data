...
public class NamesStudentOutputTests {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Count of letters in the name "+names.letterCount("Heather")); // Task 3
        System.out.println("Are the names the same "+names.theSameName("bob", "Bob")); // Task 4
